...
EXTERN void __kumir_copy_scalar(__kumir_scalar *lvalue_ptr,
                                const __kumir_scalar *rvalue);
EXTERN void __kumir_move_scalar(__kumir_scalar *lvalue, __kumir_scalar *rvalue);
EXTERN void __kumir_store_scalar(__kumir_scalar **lvalue,
                                 const __kumir_scalar *rvalue);
...
EXTERN void __kumir_input_file(const __kumir_scalar *handle,
                               const __kumir_int format, __kumir_scalar **ptr);

EXTERN void __kumir_get_scalar_argument(const char *argName,
...
EXTERN void String_Utilities_remove(__kumir_scalar *source,
                                    const __kumir_scalar *position,
